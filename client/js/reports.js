...
Visualization.list.set('livenumber', class LiveNumber extends Visualization {
	...
	render(options = {}) {
		...
		if(this.left) {
			container.insertAdjacentHTML('beforeend', `
				<div class="left">
					<h6 class="percentage ${this.getColor(this.left.percentage)}">${Format.number(this.left.percentage) || '-'}%</h6>
		...
		if(this.right) {
			container.insertAdjacentHTML('beforeend', `
				<div class="right">
					<h6 class="percentage ${this.getColor(this.right.percentage)}">${Format.number(this.right.percentage) || '-'}%</h6>
